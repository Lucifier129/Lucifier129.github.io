define(function (require, exports, mdoule) {
		...
		render: function() {
			return (
				React.createElement("div", {className: "tab"}, 
					React.createElement(Index, {className: "tab-list", list: this.props.tabList}), 
					React.createElement(RouteHandler, {list: this.props.data[this.props.path]})
				)
				)
		}
	})
		...
		render: function() {
			return(
				React.createElement("div", {className: this.props.className || ''}, 
					...
					this.props.list.map(function(item) {
						return React.createElement(Link, {to: item.path}, item.title)
					})
	...
	var Tips = React.createClass({displayName: "Tips",
		render: function() {
			return React.createElement(Main, {list: ['Not Found']})
		}
	})
	...
	var routes = (
				React.createElement(Route, {name: "app", path: "/", handler: App}, 
						...
						data.tabList.map(function(item) {
							return (
								React.createElement(Route, {name: item.path, handler: Main})
								)
						}), 
					
					React.createElement(NotFoundRoute, {handler: Tips})
				)
				)
	...
	Router.run(routes, function(Handler, state) {
		React.render(React.createElement(Handler, React.__spread({},  state,  data)), document.getElementById('container'))
	})

...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createLogger2 = __webpack_require__(54);
	...
	var _types2 = __webpack_require__(2);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hyperscript = __webpack_require__(49);
	...
	var _refer = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var didMounts = _util.info.didMounts = (0, _util.createCallbackStore)('didMounts');
	...
	var checkUnmounts = function checkUnmounts(patch) {
		...
		var resetRemove = (0, _util.wrapNative)(NodeProto, 'removeChild', callUnmounts);
		var resetReplace = (0, _util.wrapNative)(NodeProto, 'replaceChild', callUnmounts);
		patch();
		resetRemove();
		resetReplace();
	};
	...
	var Widget = (function () {
		...
		Widget.prototype.init = function init() {
			...
			var id = component.$id = (0, _util.getId)();
			setCompId(id);
	...
	var combineMixin = function combineMixin(proto, mixin) {
		for (var key in mixin) {
			...
			if (currentValue === undefined) {
				...
				proto[key] = (0, _util.pipe)(currentValue, source);
			}
		}
	};
	...
	var createClass = function createClass(options) {
		...
		var Class = (function (_Component) {
			var _class = function Class(props, context) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createDispatch = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _noVelocity = __webpack_require__(35);
	
	var _noVelocity2 = _interopRequireDefault(_noVelocity);
	
	var _hasReachedStyle = __webpack_require__(33);
	
	var _hasReachedStyle2 = _interopRequireDefault(_hasReachedStyle);
	
	var _mergeDiff = __webpack_require__(34);
	
	var _mergeDiff2 = _interopRequireDefault(_mergeDiff);
	
	var _animationLoop = __webpack_require__(30);
	
	var _animationLoop2 = _interopRequireDefault(_animationLoop);
	
	var _zero = __webpack_require__(41);
	
	var _zero2 = _interopRequireDefault(_zero);
	
	var _updateTree = __webpack_require__(40);
	
	var _deprecatedSprings2 = __webpack_require__(32);
	
	var _deprecatedSprings3 = _interopRequireDefault(_deprecatedSprings2);
	
	var _stripStyle = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _components2 = __webpack_require__(31);
	
	var _components3 = _interopRequireDefault(_components2);
	
	var _reorderKeys = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _spring = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DOMPropertyOperations = __webpack_require__(44);
	
	var _DOMProperty = __webpack_require__(5);
	
	var _HTMLDOMPropertyConfig = __webpack_require__(46);
	
	var _HTMLDOMPropertyConfig2 = _interopRequireDefault(_HTMLDOMPropertyConfig);
	
	var _SVGDOMPropertyConfig = __webpack_require__(47);
	...
	var checkEvent = function checkEvent(props) {
		...
		if (isFn(handle)) {
			...
			props.oninput = isFn(props.oninput) ? (0, _util.pipe)(props.oninput, onchange) : onchange;
	...
	var assign = function assign(properties) {
		...
		for (var _name in properties) {
			...
			if (isKey(_name)) {
				...
				hasChange = (0, _DOMPropertyOperations.assignProperties)(props, _name, value) || hasChange;
			}
		}
	...
	exports['default'] = function (tagName, properties) {
		...
		return (0, _virtualDom.h)(tagName, props, children.filter(function (child) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var render = function render(vnode, container, callback) {
		...
		if (id) {
			...
			(0, _component.richPatch)(container.firstChild, patches);
			store[id] = vnode;
		} else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _combineHandlers = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var split = __webpack_require__(59);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcReactMotion = __webpack_require__(36);
	
	var _srcPresets = __webpack_require__(18);
	...
	var Demo = _react2['default'].createClass({
	  ...
	  handleSubmit: function handleSubmit(e) {
	    ...
	    this.setState({
	      todos: _extends((_extends2 = {}, _extends2['t' + Date.now()] = { text: value, isDone: false }, _extends2), todos)
	    });
	  },
	
	  handleDone: function handleDone(key) {
	  ...
	  handleToggleAll: function handleToggleAll() {
	    ...
	    var allDone = keys.every(function (date) {
	      return todos[date].isDone;
	    });
	    keys.forEach(function (date) {
	      return todos[date].isDone = !allDone;
	    });
	    this.forceUpdate();
	  },
	  ...
	  getDefaultValue: function getDefaultValue() {
	    ...
	    return Object.keys(todos).reduce(function (configs, date) {
	      configs[date] = {
	        height: _srcReactMotion.spring(0),
	        opacity: _srcReactMotion.spring(1),
	        data: todos[date]
	      };
	      return configs;
	    }, {});
	  ...
	  getEndValue: function getEndValue() {
	    ...
	    var todos = _state2.todos;
	    var value = _state2.value;
	    var selected = _state2.selected;
	
	    return Object.keys(todos).filter(function (date) {
	      var todo = todos[date];
	      return todo.text.toUpperCase().indexOf(value.toUpperCase()) >= 0 && (selected === 'completed' && todo.isDone || selected === 'active' && !todo.isDone || selected === 'all');
	    }).reduce(function (configs, date) {
	      configs[date] = {
	        height: _srcReactMotion.spring(60, _srcPresets2['default'].gentle),
	        opacity: _srcReactMotion.spring(1, _srcPresets2['default'].gentle),
	        data: todos[date]
	      };
	      return configs;
	    }, {});
	  ...
	  willLeave: function willLeave(date, styleThatJustLeft) {
	    return {
	      height: _srcReactMotion.spring(0),
	      opacity: _srcReactMotion.spring(0),
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        'section',
	        { className: 'main' },
	        _react2['default'].createElement('input', { className: 'toggle-all', type: 'checkbox', onChange: this.handleToggleAll }),
	        _react2['default'].createElement(
	          _srcReactMotion.TransitionMotion,
	          ...
	          function (configs) {
	            return _react2['default'].createElement(
	              ...
	              Object.keys(configs).map(function (date) {
	                ...
	                var isDone = _config$data.isDone;
	                var text = _config$data.text;
	
	                var style = _objectWithoutProperties(config, ['data']);
	
	                return _react2['default'].createElement(
	                  'li',
	                  { key: date, style: style, className: isDone ? 'completed' : '' },
	                  _react2['default'].createElement(
	                    'div',
	                    { className: 'view' },
	                    _react2['default'].createElement('input', {
	                      className: 'toggle',
	                      type: 'checkbox',
	                      onChange: _this.handleDone.bind(null, date),
	                      checked: isDone
	                    }),
	                    _react2['default'].createElement(
	                      'label',
	      ...
	      _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          'button',
	          { className: 'clear-completed', onClick: this.handleClearCompleted },
	          'Clear completed'
	        )
	      )
	    );

...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Demo = __webpack_require__(88);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Demo = _react2['default'].createClass({
	  ...
	  willLeave: function willLeave(key, valOfKey) {
	    return _extends({}, valOfKey, {
	      opacity: _srcReactMotion.spring(0, [60, 15]),
	      scale: _srcReactMotion.spring(2, [60, 15])
	    });
	  },
	  ...
	  render: function render() {
	    ...
	    var _state$mouse = _state.mouse;
	    var mouseX = _state$mouse[0];
	    var mouseY = _state$mouse[1];
	    var now = _state.now;
	
	    var styles = mouseX == null ? {} : (_ref = {}, _ref[now] = {
	      opacity: _srcReactMotion.spring(1),
	      scale: _srcReactMotion.spring(0),
	      x: _srcReactMotion.spring(mouseX),
	      y: _srcReactMotion.spring(mouseY)
	    }, _ref);
	    return _react2['default'].createElement(
	      _srcReactMotion.TransitionMotion,
	      { willLeave: this.willLeave, styles: styles },
	      function (circles) {
	        return _react2['default'].createElement(
	          'div',
	          {
	          ...
	          Object.keys(circles).map(function (key) {
	            ...
	            var x = _circles$key.x;
	            var y = _circles$key.y;
